...
/**
 * Modal de formulario para editar movimientos de inventario.
 *
 * @param {Object} props
 * @param {boolean} props.isOpen - Si el modal está abierto
 * @param {Function} props.onClose - Callback para cerrar el modal
 * @param {Function} props.onSubmit - Callback para guardar los datos
 * @param {Object} props.movimiento - Movimiento a editar
 * @returns {JSX.Element}
 *
 * @example
 * <EditarMovimientoModal isOpen={true} onClose={fn} onSubmit={fn} movimiento={mov} />
 */
export default function EditarMovimientoModal({ isOpen, onClose, onSubmit, movimiento }) {
  ...
  // Cargar datos del movimiento cuando se abre el modal
  useEffect(() => {
    if (movimiento && isOpen) {
      setForm({
        tipo_movimiento: movimiento.tipo_movimiento || "Entrada",
        id_recurso: movimiento.id_recurso || "",
        cantidad: movimiento.cantidad || "",
        observaciones: movimiento.observaciones || "",
        id_estudiante: movimiento.id_estudiante || null,
        responsable: movimiento.responsable || "",
      });

      // Si hay un estudiante, configurar el selector
      if (movimiento.id_estudiante && movimiento.estudiante) {
        const estudianteData = {
          value: movimiento.id_estudiante,
          label: movimiento.estudiante
        };
