      ...
      {apoderados.length > 0 && (
        <div className="bg-white dark:bg-slate-800 rounded-lg shadow-sm border border-gray-200 dark:border-slate-700 p-4">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h4 className="text-sm font-medium text-gray-700 dark:text-gray-300">Apoderado del Estudiante</h4>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <span className="text-sm text-gray-500 dark:text-gray-400">Nombre:</span>
              <p className="font-medium text-gray-900 dark:text-white">{apoderados[0].nombre_apoderado}</p>
            </div>
            <div>
              <span className="text-sm text-gray-500 dark:text-gray-400">Email:</span>
              <p className="font-medium text-gray-900 dark:text-white">{apoderados[0].email_apoderado || 'No registrado'}</p>
            </div>
            <div>
              <span className="text-sm text-gray-500 dark:text-gray-400">Teléfono:</span>
              <p className="font-medium text-gray-900 dark:text-white">{apoderados[0].telefono_apoderado || 'No registrado'}</p>
            </div>
            <div>
              <span className="text-sm text-gray-500 dark:text-gray-400">Parentesco:</span>
              <p className="font-medium text-gray-900 dark:text-white">{apoderados[0].parentesco}</p>
            </div>
          </div>
        </div>
      )}
