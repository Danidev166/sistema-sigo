    ...
    <div className="space-y-4">
      <form onSubmit={handleFiltrar} className="flex flex-wrap gap-4 items-end mb-4">
        ...
        <div>
          ...
          <input name="motivo" value={filtros.motivo} onChange={handleChange} className="px-2 py-1 border rounded w-32" />
        </div>
        <div>
        ...
        <div>
          ...
          <select name="estado" value={filtros.estado} onChange={handleChange} className="px-2 py-1 border rounded">
