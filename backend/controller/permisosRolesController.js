...
class PermisosRolesController {
  ...
  async obtenerPorId(req, res) {
    try {
      const data = await PermisosRolesModel.obtenerPorId(req.params.id);
  ...
  async actualizar(req, res) {
    try {
      await PermisosRolesModel.actualizar(req.params.id, req.body);
  ...
  async eliminar(req, res) {
    try {
      await PermisosRolesModel.eliminar(req.params.id);
